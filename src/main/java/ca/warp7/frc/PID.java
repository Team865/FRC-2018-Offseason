...
public class PID {
	...
	/*
	Changes made: inspection fixes, no significant change
	 */

	private static class MiniPID {
	...
	public static class InputState {
		...
		public InputState setPID(Values values) {
	...
	public static class Values {
		...
		public Values(double p, double i, double d, double f) {
			P = p;
			I = i;
			D = d;
			F = f;
