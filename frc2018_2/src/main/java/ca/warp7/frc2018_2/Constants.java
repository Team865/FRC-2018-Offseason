...
public class Constants {
    ...
    public static final int[] LIFT_MOTOR_RIGHT_IDS = {10};
    ...
    public static double RIGHT_DRIFT_OFFSET = 1.0;
    public static double LEFT_DRIFT_OFFSET = 1.0;//0.825

    public static double LIFT_HEIGHT = 13000;
